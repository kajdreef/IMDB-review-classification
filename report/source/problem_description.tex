...
% \begin{itemize}
% \item Preprocess the data, using different natural language processing techniques (\eg lemmatizing, negation handling, etc.);
% \item Determine which features to use (\eg TF, TF-IDF, n-grams);
% \item Find the best classifier suitable for classifying the corpus;
